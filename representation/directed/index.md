...
A former CS228 student has created an [interactive web simulation](http://pgmlearning.herokuapp.com/dSepApp) for testing $$d$$-separation. Feel free to play around with it and, if you do, please submit any feedback or bugs through the Feedback button on the web app. This [youtube video](https://youtu.be/yDs_q6jKHb0) illustrates a few examples for determining $$d$$-separation in a graph. 
